...
- [Features](#features)
    ...
    - [Editing a person : `edit`](#editing-a-person--edit)
        - [Editing or removing a contact’s meeting : `edit`](#editing-or-removing-a-contact’s-meeting--edit)
    ...
    - [Archiving Contacts](#archiving-contacts)
        - [Archiving a contact: `archive INDEX`](#archiving-a-contact-archive-index)
        - [Viewing archived contacts: `list archived` / `list archive`](#viewing-archived-contacts-list-archived--list-archive)
    - [Unarchiving Contacts](#unarchiving-contacts)
        - [Unarchiving a contact: `unarchive INDEX`](#unarchiving-a-contact-unarchive-index)
