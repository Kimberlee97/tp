...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_LOWER_BOUND_INDEX =
            "Invalid index: index must be a positive integer (starting from 1).";
    ...
    public static final String MESSAGE_DUPLICATE_IN_ARCHIVED =
            "This contact already exists in Archived. Use 'unarchive' to restore it.";
