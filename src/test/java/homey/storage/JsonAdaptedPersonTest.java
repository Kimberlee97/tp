...
public class JsonAdaptedPersonTest {
    ...
    private static final String DEFAULT_REMARK = BENSON.getRemark().value;
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_RELATION, VALID_STAGE, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        INVALID_ADDRESS, VALID_RELATION, VALID_STAGE, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_RELATION, VALID_STAGE, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidRelation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, INVALID_RELATION, VALID_STAGE, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullRelation_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, null, VALID_STAGE, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidStage_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_RELATION, INVALID_STAGE, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullStage_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_RELATION, null, DEFAULT_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_RELATION, VALID_STAGE, DEFAULT_REMARK, invalidTags);
